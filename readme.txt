...
To change the port of the server run './server <PORT>'.
To change the port and ip of the client run './client <ip address> <PORT>'.

You can edit file 'config' if you want to modify server rules.
